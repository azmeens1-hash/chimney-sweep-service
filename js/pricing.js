/* ==========================================================================
   WarmNest Chimney — Pricing page script
   ...
   FAQ accordion. Self-contained — does not depend on home.js.
   ========================================================================== */
(function () {
  "use strict";
  ...
  faqQuestions.forEach(function (button) {
    ...
    button.addEventListener("click", function () {
      ...
      // Close any other open FAQ item so only one is open at a time.
